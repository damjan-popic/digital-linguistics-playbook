...
-   :material-source-repository: **Projects and code**

    Move from a workflow to a real repository, with notes on what to inspect, how to run it, and what to reuse.

    [:octicons-arrow-right-24: Browse projects](projects/index.md)

-   :material-pencil-plus-outline: **Contribute**

    Add a new workflow or improve an existing one using the templates and style guide.
...
The project catalogue connects selected workflows to public repositories, so readers can move from a general method to working code without losing sight of data rights, provenance, and reproducibility.
