...
- OCR correction workflows for historical Slovene.
- TEI-lite for non-experts.
- Wikidata reconciliation for cultural heritage data.
- Ethical handling of family-history data.
- Corpus workflows for small and under-resourced languages.
- LLM evaluation tasks that require citation to sources.
